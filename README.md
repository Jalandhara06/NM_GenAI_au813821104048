...
### Solution :
- The Cifar-10 dataset is trained using CNN model and achieved a accuracy of 70-80% after 10 epochs. The sample images are generated from the cifar-10 dataset along with their corresponding labels. This solution demonstrates training and evaluation for image classification and data visualization.
